...
const bodyPartDimensions = {
   ...
   'chest': {
    ...
    'rightHand': {
            ...
            path: 'm 13.793386,-0.00198533 -2.88,6.90000163 -8.4120002,1.335 -0.664,12.4579799 4.427,17.8 2.878,-0.22 -2.8,-11.847 2.99,-0.084 4.676,12.6 3.544,-0.446 -4.4,-12.736 3.072,-0.584 5.978,13.543 4.428,-0.445 -6.088,-14.1 2.1,-1.25 11.106,-22.445 3.764,0.445 -11.106,22.445 1.107,1.78 -11.106,22.445 -3.764,-0.445 11.106,-22.445 -1.107,-1.78 z'
    },
    'leftFoot': {
            class: 'left-foot',
            width: 50,
    ...
    'rightFoot': {
            ...
            height: 50,
            viewBox: '0 0 50 50',
            path: 'm 30.441643,1.92821 c 22.1993328,20.55867 11.0996668,10.27933 0,0 z m -5.975,5.989 0.664,18.415 1.55,6.435 4.647,0 1.327,-4.437 1.55,-0.222 -0.332,4.437 5.864,-1.778 1.55,-0.887 6.64,-1.442 0.22,-5.214 -6.418,-10.87 -4.4259998,-5.548 -9.991542,-3.26362 -9.41586,-8.41457 -12.836,1.111 z'
    }
        ...
        <div className="human-body">
            {Object.entries(playerBody.bodyPart).map(([bodyName, value]) => (
                <svg
                    key={bodyName}
                    id={bodyName}
                    className={bodyPartDimensions[bodyName as keyof typeof bodyPartDimensions].class}
