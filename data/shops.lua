...
--[[ 	PROBikes = {
	...
	Hurtownia4 = {
		...
		inventory = {
			...
			{ name = 'armour25',          price = 750,   grade = 6, metadata = {durability = 25, description = "Prosta kamizelka kuloodporna", weight = 750} },
			{ name = 'at_flashlight',     price = 180,   grade = 6 },
			{ name = 'snspistolset',      price = 800,   grade = 6 },
			{ name = 'snspistolsetmk2',      price = 800,   grade = 6 },
	...
	Hurtownia9 = {
		...
		inventory = {
			...
			{ name = 'beer_apple',      		price = 15 },
			{ name = 'beer_lime',      			price = 15 },
			{ name = 'beer_pear',      			price = 15 },
			{ name = 'beer_starkiwi',      		price = 15 },
			{ name = 'beer_cherryapple',      	price = 15 },
			{ name = 'beer_mango',      		price = 15 },
			{ name = 'beer_strawberry',      	price = 15 },
			{ name = 'beer_apple0',      		price = 15 },
			{ name = 'beer_lime0',      		price = 15 },
			{ name = 'beer_pear0',      		price = 15 },
			{ name = 'beer_apricot0',      		price = 15 },
			{ name = 'vodka_citrus',      		price = 30 },
			{ name = 'vodka_herb',      		price = 30 },
			{ name = 'vodka_strawberry',      	price = 30 },
			{ name = 'vodka_clean',      		price = 30 },
			{ name = 'tequila_lime',      		price = 60 },
			{ name = 'tequila_classico',      	price = 60 },
			{ name = 'tequila_oro',      		price = 60 },
			{ name = 'whisky_usa',      		price = 70 },
			{ name = 'whisky_canada',      		price = 70 },
			{ name = 'whisky_scottish',      	price = 70 },
			{ name = 'champagne_gold',      	price = 300 },
			{ name = 'champagne_tropicana',     price = 150 },
			{ name = 'champagne_rose',      	price = 200 },
			{ name = 'rum_sugar',      			price = 50 },
			{ name = 'rum_tropicana',      		price = 50 },
			{ name = 'brandy_grape',      		price = 50 },
			{ name = 'brandy_tropicana',      	price = 75 },
			{ name = 'brandy_multifruit',      	price = 75 },
			{ name = 'gin_herbs',      			price = 55 },
			{ name = 'gin_classic',      		price = 55 },
			{ name = 'vinewood_blanc',  		price = 30 },
			{ name = 'rockford_hill',  			price = 30 },
			{ name = 'vinewood_red',    		price = 30 },
			{ name = 'marlowe',         		price = 50 },
...
--			{ name = 'cctvtablet',        price = 800,     grade = 6 },
	...
	SupplierShop1 = { -- Lone Wolves
		...
		inventory = {
			...
			{ name = 'ammo-9-box',                price = 200, count = 20 },
			{ name = 'ammo-45-box',               price = 250, count = 20 },
			{ name = 'ammo-shotgun-box',          price = 350, count = 20 },
			{ name = 'ammo-rifle-box',            price = 400, count = 20 },
			{ name = 'ammo-rifle2-box',           price = 400, count = 20 },
			{ name = 'crate_9',                   price = 4000, count = 2 },
			{ name = 'crate_45',                  price = 5000, count = 2 },
			{ name = 'crate_12gauge',             price = 7000, count = 2 },
			...
			{ name = 'weapon-parts_spec',         price = 1000, count = 1 },
			{ name = 'pistolset',                 price = 2800, count = 10 },
			{ name = 'snspistolset',              price = 1800, count = 10 },
			{ name = 'pistolxm3set',              price = 3000, count = 10 },
			-- { name = 'tecpistolset',              price = 2900, count = 5 }, brak itema
			{ name = 'machinepistolset',          price = 4400, count = 5 },
			{ name = 'microsmgset',               price = 4800, count = 5 },
			-- { name = 'minismgset',                price = 3400, count = 5 }, brak itema
			{ name = 'sawnoffshotgun',            price = 5000, count = 5 },
			{ name = 'assaultrifleset',           price = 5500, count = 5 },
			{ name = 'compactrifleset',           price = 5000, count = 5 },
			{ name = 'assaultriflemk2set',        price = 8000, count = 5 },
			{ name = 'tacticalrifleset',          price = 8500, count = 5 },
			{ name = 'vanbag',                 	  price = 100, count = 5 },
			{ name = 'plate_taker',      		  price = 1250, count = 2 },
			{ name = 'plate_changer',      		  price = 1750, count = 2 },
			{ name = 'plate_changer',        price = 250,  count = 10, currency = 'black_money' }, ]]
			{ name = 'crime_token', price = 500, count = 2, currency = 'black_money' },
			{ name = 'black_money', price = 1, count = 2500, currency = 'money' },
			...
			{ name = 'big_drill', price = 3000, count = 1, currency = 'black_money' },
			...
			{ name = 'ammo-9-box', price = 200, count = 5, currency = 'money' },
			{ name = 'ammo-9-box', price = 240, count = 10, currency = 'black_money' },
			{ name = 'ammo-45-box', price = 250, count = 5, currency = 'money' },
			{ name = 'ammo-45-box', price = 300, count = 10, currency = 'black_money' },
			{ name = 'ammo-shotgun-box', price = 350, count = 5, currency = 'money' },
			{ name = 'ammo-shotgun-box', price = 420, count = 12, currency = 'black_money' },
			{ name = 'ammo-rifle-box', price = 400, count = 5, currency = 'money' },
			{ name = 'ammo-rifle-box', price = 480, count = 10, currency = 'black_money' },
			{ name = 'ammo-rifle2-box', price = 400, count = 5, currency = 'money' },
			{ name = 'ammo-rifle2-box', price = 480, count = 10, currency = 'black_money' },
			{ name = 'crate_9', price = 4000, count = 1, currency = 'money' },
			{ name = 'crate_9', price = 4800, count = 1, currency = 'black_money' },
			{ name = 'crate_45', price = 5000, count = 1, currency = 'money' },
			{ name = 'crate_45', price = 6000, count = 1, currency = 'black_money' },
			{ name = 'crate_12gauge', price = 7000, count = 1, currency = 'money' },
			{ name = 'crate_12gauge', price = 8400, count = 1, currency = 'black_money' },
			...
			{ name = 'pistolset', price = 3360, count = 6, currency = 'black_money' },
			{ name = 'pistolxm3set', price = 3000, count = 4, currency = 'money' },
			{ name = 'pistolxm3set', price = 3600, count = 6, currency = 'black_money' },
			{ name = 'tecpistolset', price = 2900, count = 2, currency = 'money' },
			{ name = 'tecpistolset', price = 3480, count = 3, currency = 'black_money' },
			...
			{ name = 'minismgset', price = 3400, count = 2, currency = 'money' },
			{ name = 'minismgset', price = 4080, count = 3, currency = 'black_money' },
			{ name = 'sawnoffshotgun', price = 5000, count = 2, currency = 'money' },
			{ name = 'sawnoffshotgun', price = 6000, count = 3, currency = 'black_money' },
			{ name = 'assaultrifleset', price = 5500, count = 2, currency = 'money' },
			{ name = 'assaultrifleset', price = 6600, count = 3, currency = 'black_money' },
			{ name = 'compactrifleset', price = 5000, count = 2, currency = 'money' },
			{ name = 'compactrifleset', price = 6000, count = 3, currency = 'black_money' },
			{ name = 'assaultriflemk2set', price = 8000, count = 2, currency = 'money' },
			{ name = 'assaultriflemk2set', price = 9600, count = 3, currency = 'black_money' },
			{ name = 'tacticalrifleset', price = 8500, count = 2, currency = 'money' },
			{ name = 'tacticalrifleset', price = 10200, count = 3, currency = 'black_money' },
