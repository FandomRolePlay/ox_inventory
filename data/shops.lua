...
--[[ 	PROBikes = {
	...
	LSSDArmoury = {
		...
		inventory = {
			...
			{ name = 'WEAPON_PISTOL_MK2',   price = 1300,  metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 1 },
			{ name = 'WEAPON_HEAVYPISTOL',  price = 1400,  metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 2 },
			{ name = 'WEAPON_SMG',          price = 3750,  metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 6 },
			{ name = 'WEAPON_COMBATPDW',    price = 4250,  metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 6 },
			{ name = 'WEAPON_PUMPSHOTGUN',  price = 3000,  metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 6 },
			{ name = 'WEAPON_SNIPERRIFLE',  price = 15000, metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 6 },
			{ name = 'WEAPON_CARBINERIFLE_MK2', price = 6750, metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 6 },
			{ name = 'WEAPON_STUNGUN',      price = 250,   metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 1 },
			{ name = 'WEAPON_BBSHOTGUN',    price = 1500,  metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 1 },
			{ name = 'WEAPON_NIGHTSTICK',   price = 100,   grade = 1 },
			{ name = 'WEAPON_COLBATON',     price = 100,   grade = 2 },
