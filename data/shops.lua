...
--[[ 	PROBikes = {
	...
	PoliceArmoury = {
		...
		inventory = {
			...
			{ name = 'WEAPON_SSCARBINERIFLE', price = 6750, metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 10 },
			{ name = 'WEAPON_SSCARBINERIFLE2', price = 6750, metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 10 },
	...
	LSSDArmoury = {
		...
		inventory = {
			...
			{ name = 'WEAPON_SSCARBINERIFLE', price = 6750, metadata = { registered = true, serial = 'LSS' }, license = 'weapon', grade = 6 },
			{ name = 'WEAPON_SSCARBINERIFLE2', price = 6750, metadata = { registered = true, serial = 'LSS' }, license = 'weapon', grade = 6 },
	...
	Marshals = {
		...
		inventory = {
			...
			{ name = 'WEAPON_SSCARBINERIFLE', price = 6750, metadata = { registered = true, serial = 'FIB' }, license = 'weapon', grade = 5 },
			{ name = 'WEAPON_SSCARBINERIFLE2', price = 6750, metadata = { registered = true, serial = 'FIB' }, license = 'weapon', grade = 5 },
...
--			{ name = 'cctvtablet',        price = 800,     grade = 6 },
	...
	SupplierShop3 = { -- Portola Drive Mob Supplier
		...
		inventory = {
			{ name = 'money', price = 1, count = 25000, currency = 'black_money' },
			{ name = 'black_money', price = 1, count = 25000, currency = 'money' },
			{ name = 'coke_seed', price = 120, count = 500, currency = 'money' },
			{ name = 'poppy_seed', price = 100, count = 500, currency = 'money' },
			{ name = 'bomb', price = 3500, count = 50, currency = 'money' },
			...
			{ name = 'ammo-9-box', price = 400, count = 100,  currency = 'money' },
			{ name = 'ammo-45-box', price = 240, count = 100, currency = 'money' },
			{ name = 'ammo-44-box', price = 320, count = 100, currency = 'money' },
			{ name = 'ammo-50-box', price = 320, count = 100, currency = 'money' },
			{ name = 'ammo-shotgun-box', price = 400, count = 100, currency = 'money' },
			{ name = 'ammo-rifle-box', price = 500, count = 100, currency = 'money' },
			{ name = 'ammo-rifle2-box', price = 500, count = 100, currency = 'money' },
