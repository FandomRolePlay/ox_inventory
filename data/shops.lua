...
--			{ name = 'cctvtablet',        price = 800,     grade = 6 },
	...
	SupplierShop1 = {
		...
		inventory = {
			...
			{ name = 'banana_kush_seed',          price = 65,  count = 35 },
			{ name = 'red_jack_seed',             price = 80, count = 35 },
			{ name = 'chem_sister_seed',          price = 80, count = 35 },
			{ name = 'coke_seed',                 price = 120,  count = 35 },
			{ name = 'poppy_seed',                price = 100, count = 35 },
