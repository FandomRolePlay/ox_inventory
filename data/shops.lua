...
--[[ 	BurgerShot = {
	...
	PoliceArmoury = {
		...
		inventory = {
			...
			{ name = 'WEAPON_COLBATON',     price = 100,   grade = 8 },
			...
			{ name = 'armour25',            price = 300,   grade = 1 },
			{ name = 'armour50',            price = 600,   grade = 5 },
			{ name = 'armour100',           price = 1200,  grade = 10 },
	...
	Marshals = {
		...
		inventory = {
			...
			{ name = 'ammo-cart',           price = 3,     grade = 1 },
			{ name = 'armour25',            price = 300,   grade = 1 },
			{ name = 'armour50',            price = 600,   grade = 2 },
			{ name = 'armour100',           price = 1200,  grade = 5 },
			{ name = 'WEAPON_FLASHBANG',    price = 375,   grade = 5 },
	...
	Sheriff2Armoury = {
		...
		inventory = {
			...
			{ name = 'ammo-bb-box',         price = 12,    grade = 1 },
			{ name = 'ammo-cart',           price = 3,     grade = 1 },
			{ name = 'armour25',            price = 300,   grade = 2 },
			{ name = 'armour50',            price = 600,   license = 'bcso_sert', grade = 2 },
			{ name = 'armour100',           price = 1600,  license = 'bcso_sert', grade = 2 },
			{ name = 'WEAPON_FLASHBANG',    price = 375,   license = 'bcso_sert', grade = 2 },
	...
	DOCArmoury = {
		...
		inventory = {
			...
			{ name = 'ammo-bb-box',         price = 12,    grade = 1 },
			{ name = 'ammo-cart',           price = 3,     grade = 1 },
			{ name = 'armour25',            price = 300,   grade = 5 },
			{ name = 'armour50',            price = 600,   grade = 5 },
			{ name = 'armour100',           price = 1200,  grade = 5 },
