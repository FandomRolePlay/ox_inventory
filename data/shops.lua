...
--[[ 	PROBikes = {
	...
	Hurtownia9 = {
		...
		inventory = {
			...
			{ name = 'logger',          price = 20 },
			{ name = 'barracho',        price = 20 },
			{ name = 'vinewood_blanc',  price = 50 },
			{ name = 'rockford_hill',   price = 50 },
			{ name = 'vinewood_red',    price = 50 },
			{ name = 'costa_del_perro', price = 50 },
			{ name = 'marlowe',         price = 50 },
			{ name = 'vodka',           price = 50 },
			{ name = 'vodka2',           price = 50 },
			{ name = 'rum',             price = 50 },
			{ name = 'whisky',          price = 70 },
			{ name = 'whisky2',          price = 70 },
			{ name = 'tequila',         price = 60 },
			{ name = 'tequila2',         price = 60 },
			{ name = 'cognac',          price = 80 },
			{ name = 'brandy',          price = 75 },
