return {
	...
	General = {
		...
		targets = {
			...
			{ loc = vec3(1164.121, -323.822, 69.232), length = 0.6, width = 0.5, heading = 345.0, minZ = 69.0, maxZ = 69.7, distance = 1.5 },
			{ loc = vec3(1291.281, -1924.131, 43.35), length = 0.6, width = 0.5, heading = 345.0, minZ = 43.0, maxZ = 43.7, distance = 1.5 },
	...
	Liquor = {
		...
		inventory = {
			...
			{ name = "scratchercard",   price = 20,   count = 20, metadata = { label = "Zdrapka 4x4", imageurl = 'nui://frp_scratchcard/images/lotto3.png', scratcherType = 'fourxfour' },   type = 'item' },
			{ name = "scratchercard",   price = 10,   count = 20, metadata = { label = "Zdrapka 4x3", imageurl = 'nui://frp_scratchcard/images/lotto2.png', scratcherType = 'fourxthree' },  type = 'item' },
			{ name = "scratchercard",   price = 5,    count = 20, metadata = { label = "Zdrapka 3x3", imageurl = 'nui://frp_scratchcard/images/lotto1.png', scratcherType = 'threexthree' }, type = 'item' }
		},
		locations = {
...
--[[ 	BurgerShot = {
	...
	YouTool = {
		...
		inventory = {
			...
			--{ name = 'starburst', price = 10 },
			--{ name = 'shotburst', price = 50 },
			--{ name = 'fountain', price = 60 },
			--{ name = 'trailburst', price = 150 },
			{ name = 'glue',            price = 3 },
			{ name = 'tape',            price = 5 },
			{ name = 'foil',            price = 5 },
	...
	PoliceArmoury = {
		...
		inventory = {
			...
			{ name = 'WEAPON_HEAVYPISTOL',  price = 1400,  metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 10 },
			...
			{ name = 'WEAPON_CARBINERIFLE', price = 6750,  metadata = { registered = true, serial = 'POL' }, license = 'weapon', grade = 10 },
	...
	Hurtownia4 = {
		...
		inventory = {
			{ name = 'weapon-parts',      price = 50,   grade = 7 },
			{ name = 'weapon-cleaning',   price = 50,   grade = 7 },
			{ name = 'blueprint_an',      price = 500,   grade = 7 },
			{ name = 'weaponcase',        price = 50,   grade = 7 },
			{ name = 'longweaponcase',    price = 100,   grade = 7 },
			{ name = 'armour25',          price = 750,   grade = 7 },
			{ name = 'at_flashlight',     price = 180,   grade = 7 },
			{ name = 'snspistolset',      price = 800,   grade = 7 },
			{ name = 'pistolset',         price = 950,   grade = 7 },
			{ name = 'pistolxm3set',      price = 1200,   grade = 7 },
			{ name = 'pistol50set',       price = 1600,   grade = 7 },
			{ name = 'revolverset',       price = 1750,   grade = 7 },
			{ name = 'pumpshotgunset',    price = 4550 ,   grade = 7 },
			{ name = 'smgset',            price = 5900,   grade = 7  },
			{ name = 'weapon_machete',    price = 150,   grade = 7 },
			{ name = 'weapon_switchblade',price = 100,   grade = 7 },
			{ name = 'weapon_knife',      price = 65,   grade = 7  },
			{ name = 'weapon_bat',        price = 35,   grade = 7  },
			{ name = 'weapon_flashlight', price = 20,   grade = 7  },
			{ name = 'weapon_flare',      price = 25,   grade = 7  },
			{ name = 'ammo-45-box',       price = 45,   grade = 7  },
			{ name = 'ammo-50-box',       price = 70,   grade = 7  },
			{ name = 'ammo-9-box',        price = 25,   grade = 7  },
			{ name = 'ammo-44-box',       price = 40,   grade = 7  },
			{ name = 'ammo-shotgun-box',  price = 10,   grade = 7  },
			{ name = 'ammo-rifle-box',    price = 110,   grade = 7  },
			{ name = 'crate_45',       price = 900,   grade = 7  },
			{ name = 'crate_50',       price = 1400,   grade = 7  },
			{ name = 'crate_9',        price = 750,   grade = 7  },
			{ name = 'crate_44',       price = 800,   grade = 7  },
			{ name = 'crate_12gauge',  price = 200,   grade = 7  },
		},
		locations = {
	...
	Hurtownia9 = {
		...
		inventory = {
			...
			{ name = 'logger',          price = 5 },
			{ name = 'barracho',        price = 5 },
			{ name = 'vinewood_blanc',  price = 15 },
			{ name = 'rockford_hill',   price = 15 },
			{ name = 'vinewood_red',    price = 15 },
			{ name = 'costa_del_perro', price = 15 },
			{ name = 'marlowe',         price = 20 },
			{ name = 'vodka',           price = 15 },
			{ name = 'rum',             price = 22 },
			{ name = 'whisky',          price = 25 },
			{ name = 'tequila',         price = 30 },
			{ name = 'cognac',          price = 40 },
			{ name = 'bleuterd',        price = 50 },
			{ name = 'bottle', price = 1 },
			{ name = 'water',  price = 2 },
			{ name = 'water2', price = 7 },
			{ name = 'sprunk', price = 2 },
